...
class PortfolioViewSet(viewsets.ViewSet):
    ...
    def create(self, request):
        ...
        print('t1: ', t1)
        #np.savetxt(r'c:\data\np.txt', t1.values, fmt='%d')
        #np.savetxt(r'C:\Users\chris\OneDrive\Desktop\ai project\np.txt', t1.values, fmt='%d')
        #print('t1 titles: ', t1.columns)
        #print('return table titles: ', return_table.keys())


        period = 21 #Just updated period to be weekly by default. Need
        # to deterine why there is the period = period+2 issue with
        # Pandas...
        # #21 is roughly monthly, period 3 is roug#hly weekly
        ...
        #print('aggressive_percent: ', aggressive_percent)
